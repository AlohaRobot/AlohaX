...
from alohax_hw_bridge.motors.feetech import (
    FeetechMotorsBus,
    OperatingMode,
)
...
def build_motors_from_scan(port: str):
    ...
    """
    # Motor and MotorNormMode 已经在顶部导入了，不需要再次导入
...
def move_motors_by_script(port, script_path):
    motors = {
        "gripper": Motor(8, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
        "wrist_roll": Motor(6, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
        "wrist_yaw": Motor(5, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
        "wrist_flex": Motor(4, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
        "elbow_flex": Motor(3, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
        "shoulder_lift": Motor(2, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
        "shoulder_pan": Motor(1, DEFAULT_FEETECH_MODEL, MotorNormMode.RANGE_0_100),
    }
